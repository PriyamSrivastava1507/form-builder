  ...
  return (
    <div>
      <input 
        ...
        onKeyDown={onKeyDown}
        className="max-xl:w-[188px] pl-1.5 pr-1 pt-1 pb-px mt-2 rounded-sm border-b-2 border-transparent bg-surface-overlay/60 outline-none text-foreground/80 xl:text-base lg:text-sm placeholder:text-foreground/60 hover:bg-surface-raised/60 hover:border-b-2 hover:border-primary/50
