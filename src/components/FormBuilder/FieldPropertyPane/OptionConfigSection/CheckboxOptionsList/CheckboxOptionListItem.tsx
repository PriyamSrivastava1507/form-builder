...
type CheckboxOptionListItemProps = {
    field: CheckboxGroupField;
    sortedIndex: number;
    optionIndex: number;
}

const CheckboxOptionListItem = ({field, optionIndex, sortedIndex}: CheckboxOptionListItemProps) => {
...
export default CheckboxOptionListItem